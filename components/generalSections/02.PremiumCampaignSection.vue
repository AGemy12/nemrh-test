<template>
  <section class="premium_campaign_section_content_wrapper">
    <div class="container">
          ...
          <div class="row justify-content-evenly align-items-center">
            ...
            >
              <a
                ...
                :href="sectionData.top_companies.company.link"
                target="_blank"
              >
                <img
                  class="premium_campaign_image"
                  :alt="sectionData.company.title"
                  width="100"
                  height="100"
                  loading="lazy"
                />
...
<style lang="scss">
.premium_campaign_section_content_wrapper {
