<template>
  <section class="company_details_form_step_wrapper">
    <div class="step_title_wrapper">
      ...
      <h2 class="step_title">
        {{ $t('TITLES.CompaniesAndCampaignsForms.companyDetails') }}
      </h2>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      data: {
        nameAr: {
          value: this.companyDetails?.title_ar || 'غير موجود',
          error: null,
        },
        nameEn: {
          value: this.companyDetails?.title_en || 'غير موجود',
          error: null,
        },
        serviceAr: {
          value: this.companyDetails?.main_service_ar || 'غير موجود',
          error: null,
        },
        serviceEn: {
          value: this.companyDetails?.main_service_en || 'غير موجود',
          error: null,
        },
        workField: {
        ...
        aboutCompanyAr: {
          value: this.companyDetails?.desc_ar || 'غير موجود',
          error: null,
        },
        aboutCompanyEn: {
          value: this.companyDetails?.desc_en || 'غير موجود',
          error: null,
        },
      },
      ...
      validationSchema: {
        ...
        workFieldRules: [
          (val) => !!val || this.$t('FORMS.Validation.workField'),
        ],
        aboutCompanyRules: [
          (val) => !!val || this.$t('FORMS.Validation.aboutCompany'),
        ],
      },
